...
void Scene3::Init()
{
	...
	meshList[GEO_CIRCLE] = MeshBuilder::GenerateCircle("circle", Color(0, 1, 0));
	meshList[GEO_RING] = MeshBuilder::GenerateRing("ring", Color(0, 0, 1), 0.5, 3);
	meshList[GEO_SPHERE] = MeshBuilder::GenerateSphere("sphere", Color(1, 0, 1), 10, 20);
}
