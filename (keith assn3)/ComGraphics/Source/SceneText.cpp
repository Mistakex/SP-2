...
void SceneText::Init()
{
	...
	meshList[GEO_MODEL1] = MeshBuilder::GenerateOBJ("model", "OBJ//doorman.obj");
	meshList[GEO_MODEL1]->textureID = LoadTGA("Image//doorman.tga");
	...
	Mtx44 projection;
	projection.SetToPerspective(45.0f, 4.0f / 3.0f, 0.1f, 5000.0f);
...
void SceneText::Render()
{
	...
	RenderText(meshList[GEO_TEXT], "CB SEETOO FUCKING RETARD", Color(0, 1, 0));
	modelStack.PopMatrix();

	modelStack.PushMatrix();
	RenderTextOnScreen(meshList[GEO_TEXT], framerate.str(), Color(0, 1, 0), 3, 1, 1);
	framerate.str("");
	modelStack.PopMatrix();
